<template>
  ...
  >
    ...
    <div class="login">
      ...
      <h4 :class="{ 'light-text': !isDarkMode, 'dark-mode': isDarkMode }">
        登录到Vue
      </h4>
      <input
        type="email"
      ...
      <router-link
        to="/recover"
        :class="{ 'light-recover': !isDarkMode, 'dark-recover': isDarkMode }"
        >忘记密码？</router-link
      >
      <button @click="toggleDarkMode">切换显示模式</button>
    </div>
  </div>
</template>
...
.light-field {
  ...
  border: 1px solid rgba(19, 16, 16, 0.2);
